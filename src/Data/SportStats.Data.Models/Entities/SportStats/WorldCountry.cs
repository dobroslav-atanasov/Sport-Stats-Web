...
[Table("WorldCountries", Schema = "dbo")]
public class WorldCountry : BaseEntity<int>, ICreatableEntity, IDeletableEntity, IUpdatable<WorldCountry>
{
    [Required]
    [MaxLength(100)]
    ...
    public bool Update(WorldCountry other)
    {
        var isUpdated = false;
